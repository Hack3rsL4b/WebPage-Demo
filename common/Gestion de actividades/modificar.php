        ...
        <table width="636">
          ...
          <tr>
            ...
            <td><label for="cid"></label>
              <input class="inputmod" name="cid" type="text" id="cid" size="45" value="<?php echo $fila['id_actividad']; ?>" disabled />
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><label for="cdescripcion"></label>
              <input class="inputmod" name="cdescripcion" type="text" id="cdescripcion" size="45" value="<?php echo $fila['descripcion']; ?>" />
            </td>
          </tr>
          <tr>
            <td class="tdclass">ENLACE: </td>
            <td><label for="cenlace"></label>
              <input class="inputmod" name="cenlace" type="text" id="cenlace" size="45" value="<?php echo $fila['enlace']; ?>" />
            </td>
          </tr>
          <tr>
