        ...
        <table width="636">
          ...
          <tr>
            ...
            <td><label for="cid"></label>
              <input class="inputmod" name="cid" type="text" id="cid" size="45" value="<?php echo $fila['id_usuario']; ?>" disabled />
            </td>
          </tr>
          <tr>
            <td class="tdclass">USUARIO: </td>
            <td><label for="cuser"></label>
              <input class="inputmod" name="cuser" type="text" id="cuser" size="45" value="<?php echo $fila['usuario']; ?>" />
            </td>
          </tr>
          <tr>
            <td class="tdclass">CONTRASEÑA: </td>
            <td><label for="cclave"></label>
              <input class="inputmod" name="cclave" type="text" id="cclave" size="45" value="<?php echo $fila['contrasenia']; ?>" />
            </td>
          </tr>
          <tr>
            <td class="tdclass">NOMBRE: </td>
            <td><label for="cnombre"></label>
              <input class="inputmod" name="cnombre" type="text" id="cnombre" size="45" value="<?php echo $fila['nombre']; ?>" />
            </td>
          </tr>
          <tr>
            <td class="tdclass">APELLIDO: </td>
            <td><label for="capellido"></label>
              <input class="inputmod" name="capellido" type="text" id="capellido" size="45" value="<?php echo $fila['apellido']; ?>" />
            </td>
          </tr>
          <tr>
            <td class="tdclass">TELEFONO: </td>
            <td><label for="ctelefono"></label>
              <input class="inputmod" name="ctelefono" type="text" id="ctelefono" size="45" value="<?php echo $fila['telefono']; ?>" />
            </td>
          </tr>
          <tr>
            <td class="tdclass">EMAIL: </td>
            <td><label for="cemail"></label>
              <input class="inputmod" name="cemail" type="text" id="cemail" size="45" value="<?php echo $fila['email']; ?>" />
            </td>
          </tr>
          <tr>
